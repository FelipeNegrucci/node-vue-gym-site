<template>
<svg fill="var(--bs-light)" viewBox="-10 0 100 60" width="48">
    <rect width="80" height="10" x="10" y="0" rx="4"></rect>
    <rect width="80" height="10" x="10" y="25" rx="4"></rect>
    <rect width="80" height="10" x="10" y="50" rx="4"></rect>
</svg>
</template>
